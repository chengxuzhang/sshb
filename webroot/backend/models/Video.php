...
class Video extends \backend\components\BaseModel
{
     ...
     * 获取上传视频的授权
     */
    public function getUploadVideoKey(){
        $id = CacheConfig::getConfigCache("accessKeyId");// 请填写您的AccessKeyId。
        $key= CacheConfig::getConfigCache("accessKeySecret"); // 请填写您的AccessKeySecret。
