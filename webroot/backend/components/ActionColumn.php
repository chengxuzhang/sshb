    ...
    protected function initDefaultButtons()
    {
        if (!isset($this->buttons['view'])) {
            $this->buttons['view'] = function ($url, $model, $key) {
                ...
                return Html::a("<i class='glyphicon glyphicon-eye-open'></i>  ".Yii::t('app/html','View'), $url, $options);
            };
        }
        if (!isset($this->buttons['update'])) {
            $this->buttons['update'] = function ($url, $model, $key) {
                ...
                return Html::a("<i class='glyphicon glyphicon-pencil'></i>  " . Yii::t('app/html','Update'), $url, $options);
            };
        }
        ...
        if (!isset($this->buttons['nodelete'])) {
            $this->buttons['nodelete'] = function ($url, $model, $key) {
                $options = array_merge([
                    'title' => Yii::t('yii', 'noDelete'),
                    'aria-label' => Yii::t('yii', 'noDelete'),
                    'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this item?'),
                    'data-method' => 'post',
                    'data-pjax' => '0',
                    'class' => 'btn btn-default btn-xs ajax-get confirm',
                ], $this->buttonOptions);
                return Html::a("<i class='glyphicon glyphicon-fire'></i>  ".Yii::t('app/html','noDelete'), $url, $options);
            };
        }
    }
