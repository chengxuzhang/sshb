...
layui.config({
    ...
    var html = "<link rel=\"stylesheet\" href=\"/layui/css/cropper.css\">\n" +
        ...
        "               </div>\n" +
        "               <div class=\"layui-col-md12 img-preview\" style=\"width:100px;height:100px;padding:0px;margin-top:30px;overflow:hidden\">\n" +
        "               </div>\n" +
        "           </div>\n" +
        "        </div>\n" +
        "    </div>\n" +
            ...
            $(".layui-btn").on('click',function () {
                ...
                if(event === 'confirmSave'){
                    image.cropper("getCroppedCanvas",{
                        ...
                        formData.append(field,blob,'test.jpg');
                        $.ajax({
                            method:"post",
