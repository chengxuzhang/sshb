		...
		<div class="zj-mobile__body-content">
			<div class="zj-mobile__content-form-block">
				...
				<div class="weui-cell zj-mobile__form-input">
		            <div class="weui-cell__bd">
		                <input id="client_name" name="client_name" class="weui-input" placeholder="填写姓名"/>
		            </div>
	          	</div>
			</div>
			...
			<div class="zj-mobile__content-form-block">
				...
				<div class="weui-cell zj-mobile__form-input">
		            <div class="weui-cell__bd">
		                <input id="house_address" name="house_address" class="weui-input" placeholder="填写楼栋单元室信息"/>
		            </div>
	          	</div>
			</div>
			...
			<div class="zj-mobile__content-form-block">
				...
				<div class="weui-cell zj-mobile__form-input">
		            <div class="weui-cell__bd">
		                <input id="client_phome" id="client_phome" class="weui-input" placeholder="填写电话"/>
		            </div>
	          	</div>
			</div>
		            ...
		            <div class="weui-cell__bd">
				        <div class="weui-cells_radio">
				            <label class="weui-cell">
				                <div class="weui-cell__hd">
				                    <input type="radio" class="weui-check" name="sex" checked="checked" value="男" />
				            ...
				            <label class="weui-cell">
				                <div class="weui-cell__hd">
				                    <input type="radio" name="sex" class="weui-check" value="女" />
				                    <i class="weui-icon-checked"></i>
				                </div>
				                <div class="weui-cell__bd">
				                    <p>女</p>
	                    ...
	                    <div class="weui-media-box__hd">\
	                        <div class="weui-cells_checkbox">\
					            <label class="zj-mobile__label-checkbox">\
					                <input type="checkbox" class="weui-check zj-mobile__attribute-checkbox" name="checkbox_'+n.id+'" value="'+n.id+'"/><i class="weui-icon-checked"></i>'+n.name+'\
					            </label>\
					        </div>\
	                    </div>\
	                    <div class="weui-media-box__bd zj-mobile__attribute-color">\
	                    	<div class="zj-mobile__color-area">\
	                        	<a href="javascript:void(0);" style="background-color:'+n.productAttribute[0].value+';" class="selectColor" data-id="'+n.id+'" data-cid="'+n.productAttribute[0].id+'" data-color="'+n.productAttribute[0].value+'"></a>\
	                        	<em></em>\
	                        </div>\
	                        <div class="zj-mobile__amount-area">\
	                        	<a href="javascript:void(0);" class="selectAmount" data-id="'+n.id+'" data-cid="'+n.productAttribute[0].id+'">1</a>\
	                        	<em></em>\
	                        </div>\
	                    </div>\
	                    <div class="weui-media-box__ft zj-mobile__media-box-price">\
	                        <span class="zj-mobile__attribute-price-default" style="display: none;">'+n.productAttribute[0].price_default+'</span>\
	                        <span class="zj-mobile__attribute-price">'+n.productAttribute[0].price+'</span>\
	                    </div>\
	                </div>';
				});
				content += '</div>';
	...
	$(document).on('click','.selectColor', function(){
		...
		weui.picker(tempList, {
		   onConfirm: function (result) {
		   		...
		   		_this.attr("data-color", result[0].extend.value);
    ...
    $(document).on("click", ".selectAmount", function() {
 	...
 	$("#save").click(function(){
	    ...
	    submitObj.project_attribute = JSON.stringify(json);
 		$.post("/offer/createProjectNum/api", submitObj, function(result){
 			if(result.result){
