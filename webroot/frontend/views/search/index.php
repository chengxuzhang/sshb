        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-breadcumb"> <i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a href='/'>主页</a> > <a href='javascript:;'>搜索结果</a> > </span> </div>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="row portfolio-3-columns isotope-x clearfix">
                                ...
                                <div class="portfolio-item isotope-item col-sm-4 col-xs-6">
                                    <article>
                                        ...
                                        <h5 class="item-title">
                                            <a href="/product/detail/<?= $val->id ?>.html" title="<?= $val->title ?>">
                                                <?= str_replace($keywords, '<span class="red">'.$keywords.'</span>', $val->title) ?>
                                            </a>
                                        </h5>
