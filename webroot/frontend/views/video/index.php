                                ...
                                <div class="portfolio-item isotope-item col-sm-4 col-xs-6">
                                    <article>
                                        <figure class="glass-animation">
                                            <a class="swipebox see-video" href="javascript:;" data-link="<?= $val->link ?>" data-title="<?= $val->title ?>">
                                        ...
                                        <h5 class="item-title">
                                            <a href="javascript:;" class="see-video" title="<?= $val->title ?>" data-link="<?= $val->link ?>" data-title="<?= $val->title ?>">
                                                <?= $val->title ?>
                                            </a>
                                        </h5>
