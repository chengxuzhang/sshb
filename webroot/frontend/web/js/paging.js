(function ($, window, document) {
    ...
    Paging.prototype = {
        constructor: Paging, init: function () {
            ...
            console.info(this);
            var that = this, ulDom = '', jumpDom = '', content = '', liWidth = 45, totalPages = that.options.totalPages,
                wrapLength = 0;
            ...
            content = '<div class="pagger-box"><div class="pageWrap" style="width:' + wrapLength + 'px">' +
            ...
            var that = this;
            var $el = that.el;
            var pageSelect = $el.find('.pageSelect'), lis = pageSelect.children(), liWidth = 45,
                totalPages = that.options.totalPages, pageIndex = that.options.pageNo, distance = 0,
                prePage = $el.find('.pre-page'), nextPage = $el.find('.next-page'), firstPage = $el.find('.first-page'),
                lastPage = $el.find('.last-page'), jumpBtn = $el.find('.jump-button'),
